...
const ProjectPage = () => {
  ...
  return (
    ...
    <Row className="align-items-center mb-3">
        <Col>
        <h1 className="mb-2 no-wrap-title">{project.title}</h1>
        </Col>
        <Col className="text-end mt-3 mt-md-0">
        <Button className='copy-link-button bg-dark py-2 px-4' onClick={handleCopyLink}>Copy Link</Button>
        </Col>
    </Row>
    ...
    <Row className="mb-5 text-center">
        ...
        <ul className="list-unstyled">
            <li>
            <a href={project.liveUrl} target="_blank" rel="noopener noreferrer" className='text-dark'>Live Site on Netlify</a>
            </li>
            <li>
            <a href={project.repoUrl} target="_blank" rel="noopener noreferrer" className='text-dark'>GitHub repository</a>
            </li>
        </ul>
        </Col>
    </Row>
